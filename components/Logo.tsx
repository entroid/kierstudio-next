    ...
    <div className={`relative ${className}`}>
      ...
      >
        <g>
          ...
          <rect fill={ierColor} height="285" width="74" x="368.996" y="178" />
          <g>
            <rect fill={ierColor} height="285" width="74" x="822.998" y="178.5" />
            <path d={svgPaths.p1eade380} fill={ierColor} />
          </g>
          <g>
            <path d={svgPaths.p1a690fc0} fill={ierColor} />
            <path d={svgPaths.p1a64f200} fill={ierColor} />
          </g>
          <circle cx="405.998" cy="101" fill={ierColor} r="45" />
        </g>
