            ...
            <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
                ...
                >
                    ...
                    <motion.h2
                        ...
                        className="titulo text-[#D52169]  text-[3rem] md:text-[6rem] lg:text-[6.25rem] leading-[1] tracking-[-0.04em] text-[#28292D] dark:text-white mb-8 uppercase"
                            ...
                            <div className="grid lg:grid-cols-12 gap-8 py-8 md:py-16 lg:py-20 items-start">
                                ...
                                <div className="lg:col-span-6">
                                    <motion.h3
                                        ...
                                        className="titulo text-[1.875rem] md:text-[3.5rem] lg:text-[3.25rem] xl:text-[4rem] leading-[0.9] tracking-[-0.02em] text-[#28292D] dark:text-white mb-6"
                                    >
                                        {step.title}
                                    </motion.h3>
