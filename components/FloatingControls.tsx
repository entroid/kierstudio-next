          ...
          >
            ...
            <AnimatePresence>
              {accessibilityOpen && (
                ...
                >
                  <h3
                    className="font-archivo text-[1.125rem] text-[#28292D] dark:text-white mb-6"
                  ...
                  <div className="mb-6 pb-6 border-b border-[#28292D]/10 dark:border-white/10">
                    <label
                      className="font-archivo text-[0.75rem] tracking-[0.1em] uppercase text-[#28292D]/70 dark:text-white/60 mb-3 block"
                    ...
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <span
                        className="font-archivo text-[0.875rem] text-[#28292D] dark:text-white min-w-[60px] text-center"
                        style={{ fontWeight: 600 }}
                      >
                      ...
                      <motion.button
                        ...
                        className="px-3 py-2 bg[#F5F5F5] dark:bg-[#28292D] rounded-lg font-archivo text-[0.6875rem] hover:bg-[#D52169] hover:text-white transition-colors cursor-pointer"
                        style={{ fontWeight: 600 }}
                      >
                        Reset
                      </motion.button>
                  ...
                  <div className="mb-4">
                    ...
                    >
                      <span
                        className="font-archivo text-[0.8125rem] flex items-center gap-3"
                        style={{ fontWeight: 600 }}
                      >
          ...
          >
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="font-archivo text-white text-[0.8125rem] font-bold tracking-wider"
              >
                {language === "en" ? "EN" : "ES"}
              </motion.div>
            </AnimatePresence>
