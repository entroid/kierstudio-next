    ...
    <footer className="bg-[#28292D] dark:bg-black text-white pt-32 pb-8 transition-colors duration-500">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-16 pb-20 border-b border-white/10">
          ...
          >
            <motion.h2
              className="titulo text-[4rem] md:text-[6rem] leading-[0.85] tracking-[-0.03em] text-white mb-8"
            >
              ©KIER
              <br />
              STUDIO
        ...
        >
          <div className="grid md:grid-cols-2 gap-8 items-end">
            <div>
              ...
              <h3
                className="titulo text-[2rem] md:text-[3rem] text-white leading-[1.1] mb-3"
              >
